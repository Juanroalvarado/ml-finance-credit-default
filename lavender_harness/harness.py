...
if __name__ == "__main__":
    ...
    predictions['results'] = trained_model.predict(test_data_proc)
    predictions['calibrated_prediction_new'] = calibrator(predictions['results'])
    print("Predictions done")
    predictions['calibrated_prediction_new'].to_csv(output_path,index=False,header=False)
